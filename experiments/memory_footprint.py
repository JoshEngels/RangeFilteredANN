...
parser.add_argument(
    "--alpha", type=float, default=1.0, help="Alpha for all graph based methods"
)
...
vamana_tree, memory_usage = get_vamana_tree(
    data, filter_values, metric, args.alpha, args.vamana_tree_split_factor
)
